...
if(void 0===e["[[boundFormat]]"]){var r=oe.call((function(){var e=arguments.length<=0||void 0===arguments[0]?void 0:arguments[0],r=void 0===e?Date.now():a(e)
...
for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e},K="undefined"==typeof global?self:global,Y=function(e,r){if(Array.isArray(e))return e
...
var r=arguments[0],t=arguments[1],n=new T(r,t=M(t,"any","all"))
return R(n,e)},Ne.Date.toLocaleDateString=function(){if("[object Date]"!==Object.prototype.toString.call(this))throw new TypeError("`this` value must be a Date instance for Date.prototype.toLocaleDateString()")
var e=+this
if(isNaN(e))return"Invalid Date"
var r=arguments[0],t=arguments[1],n=new T(r,t=M(t,"date","date"))
return R(n,e)},Ne.Date.toLocaleTimeString=function(){if("[object Date]"!==Object.prototype.toString.call(this))throw new TypeError("`this` value must be a Date instance for Date.prototype.toLocaleTimeString()")
var e=+this
if(isNaN(e))return"Invalid Date"
var r=arguments[0],t=arguments[1],n=new T(r,t=M(t,"time","time"))
return R(n,e)},J(xe,"__applyLocaleSensitivePrototypes",{writable:!0,configurable:!0,value:function(){for(var e in J(Number.prototype,"toLocaleString",{writable:!0,configurable:!0,value:Ne.Number.toLocaleString}),J(Date.prototype,"toLocaleString",{writable:!0,configurable:!0,value:Ne.Date.toLocaleString}),Ne.Date)V.call(Ne.Date,e)&&J(Date.prototype,e,{writable:!0,configurable:!0,value:Ne.Date[e]})}}),J(xe,"__addLocaleData",{value:function(e){if(!l(e.locale))throw new Error("Object passed doesn't identify itself with a valid language tag")
